...
function createConfidenceOutputRecord(
     ...
     *
     * Financial evidence is preserved inside:
     *
     *     record.evidence
     *
     * Confidence state is preserved inside:
     *
     *     record.confidence
     *
     * This function performs projection only.
     * It does not calculate or modify confidence.
     */
    ...
    return {
        ...
        /*
         * Identity and financial fields originate from
         * the preserved FIPE-4 evidence record.
         */
        ...
        /*
         * Nullish coalescing is deliberate.
         *
         * A legitimate financial value of zero must remain zero.
         */
        ...
        /*
         * Authoritative confidence state.
         *
        ...
        /*
         * Provenance belongs to the preserved FIPE-4
         * evidence record.
         */
